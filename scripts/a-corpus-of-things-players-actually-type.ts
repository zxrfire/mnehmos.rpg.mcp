...
export const CORPUS: Command[] = [
    ...
    ...P('move', 'I travel to Low Fall', 'I go to Nine Peaks', 'travel to Thousand Sail Harbour', 'I head for the market town', 'I walk to Low Fall'),
    ...O('move', 'I set out for Nine Peaks', 'I leave for Thousand Sail Harbour', 'I make my way to Low Fall', 'take me to Nine Peaks'),
