...
export const CORPUS: Command[] = [
    ...
    ...P('move', 'I travel to Emerald Water City', 'I go to Nine Peaks', 'travel to Silver Island', 'I head for the market town', 'I walk to Emerald Water City'),
    ...O('move', 'I set out for Nine Peaks', 'I leave for Silver Island', 'I make my way to Emerald Water City', 'take me to Nine Peaks'),
