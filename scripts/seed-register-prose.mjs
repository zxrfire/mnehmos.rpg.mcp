...
const TEXT = {
    ...
    register:
        'The admission column runs against the ordinal column. The strongest body on the sheet asks for twenty-nine; the weakest asks for nothing, and three others also take anyone who walks up. Exactly one door is shut. Six factions could field something stronger than anything they can put in a room, and eleven hold their vein on a grant, which leaves most of the register standing on ground nobody issued.',
    ...
    items:
        'Every object known to exist is in three hands, with nothing unaccounted for: thirteen Steps and four Dealings, all of them held. The Pavilion holds nine of the seventeen, more than the two older bodies together. The youngest institution on the sheet is sitting on most of the supply, and none of it can be replaced.',
