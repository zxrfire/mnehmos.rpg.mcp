...
export const THE_REMAINDER = {
    ...
    theWandererIsTheWorkedCase:
        'Lu Sheng crossed six hundred and forty years ago and holds the rung\'s figure less the years he had already lived: about two hundred and ninety-eight thousand. The crossing charged him nothing in years. He is well under one per cent of the way through his own span, which by the standards of this file makes him young, and the whole of the trajectory in this file lies ahead of him - he is exactly the case the paragraph above describes as the one the world will remember. None of it is close. The second stage is nineteen thousand years off, and for every century anybody alive will see he is the man he is now.'
} as const;
