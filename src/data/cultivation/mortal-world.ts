...
export const SETTLEMENTS: readonly Settlement[] = [
    ...
    },
    {
        ...
        contains: ['an auction house', 'a Stone Marrow assay hall', 'nine gates, all registering', 'a Vermilion Seal Terrace oath hall', 'more cultivators than anybody has counted'],
