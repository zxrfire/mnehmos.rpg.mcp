...
const OCCUPATION_DATA: readonly Occupation[] = [
    ...
    { id: 'job-herb-picker', name: 'Herb picker', kind: 'either', minOrdinal: 0, cashPerMonth: 220, settlements: ['hamlet', 'village', 'market_town'], risk: 'moderate', note: 'Mortal-grade herbs off safe ground. The Cinnabar Crucible Sect buys at a fixed rate and does not haggle, which pickers regard as fair and dull.' },
...
export const PRICES: readonly Price[] = [
    ...
    { id: 'price-meal', name: 'Hot meal at an inn', category: 'food', cash: 6, unit: 'each', note: 'Fish and rice in the Jade Gorge; flatbread and sour broth in the Buddha Precipice, at half again the price.', gives: { kind: 'a_meal' } },
    ...
    { id: 'price-caravan-passage', name: 'Caravan passage', category: 'transport', cash: 250, unit: 'per 100 li', note: 'Includes food and the protection of being one of a group. The border road to Iron Crest is eleven days and priced as such.', gives: { kind: 'quoted_only', because: 'passage is bought by naming where you are going, not at a counter' } },
    ...
    { id: 'price-water-jar', name: 'Fresh water, sealed stone jar', category: 'food', cash: 30, unit: 'jar', note: 'Six days of drink for one person. Silver Island sells it at a margin nobody argues about, because a shipmaster haggling over water in front of a crew has already lost the crew.', gives: { kind: 'spent_at_the_counter', what: 'a sealed jar, heavy, and six days of not thinking about it' } },
    { id: 'price-hull-repair', name: 'Hull repair at a quay', category: 'service', cash: 2_200, unit: 'per call', note: 'Caulking, cordage and canvas. Silver Island Hall keeps eleven caulkers and does not price them to profit, on the reasoning that a hull that cannot be repaired there is a hull that stops coming.', gives: { kind: 'quoted_only', because: 'a quay repairs a hull for whoever owns one, and you do not' } },
    ...
    { id: 'price-clear-meridian-pill', name: 'Clear Meridian Pill', category: 'medicine', cash: 6_000, unit: 'each', note: 'Sixty stones, and unobtainable in the Buddha Precipice at any price because alchemy will not hold there.', gives: { kind: 'pill', pillId: 'pill-clear-meridian' } },
    ...
    { id: 'price-grant-day', name: 'Grant day at a workable face', category: 'land', cash: 4_000, unit: 'day', note: 'Forty stones a DAY, Buddha Precipice only, and the reason nobody there saves anything.', gives: { kind: 'quoted_only', because: 'a face is worked by arrangement with whoever holds it' } },
    ...
    { id: 'price-chisel', name: 'Carver\'s chisel', category: 'tool', cash: 450, unit: 'each', note: 'Lasts about a season at a face. In the Buddha Precipice this is a recurring cost of cultivating, which the Jade Gorge finds absurd.', gives: { kind: 'spent_at_the_counter', what: 'a chisel that will last about a season at a face' } },
    { id: 'price-mortal-sword', name: 'Sword, mortal steel', category: 'tool', cash: 700, unit: 'each', note: 'Ashen Anvil work, reforged from ploughed-up fragments. A cultivator\'s blade starts at fifty times this.', gives: { kind: 'spent_at_the_counter', what: 'mortal steel, honest and unremarkable' } },
...
export const SETTLEMENTS: readonly Settlement[] = [
    ...
    },
    {
        ...
        contains: ['a changer who sets the cash-to-stone rate', 'an inn with private rooms', 'a physician', 'a Jade Register Hall register at the gate', 'a Ledger arbitration bench on circuit'],
    ...
    },
    {
        ...
        contains: ['an auction house', 'a Stone Marrow assay hall', 'nine gates, all registering', 'a Vermilion Sigil Terrace oath hall', 'more cultivators than anybody has counted'],
...
export const MORTAL_ATTITUDES: readonly MortalAttitude[] = [
    ...
    },
    {
        ...
        quietMarches: 'Stared at in the street. A Standing Cut carver is among the strongest people most Buddha Precipice towns have met, and the Jade Gorge visitor who does not know that is walking around underestimating everyone.'
    },
    {
    ...
    },
    {
        ...
        quietMarches: 'No frame of reference. The Buddha Precipice has produced two people at this height in nine hundred years and both left, so the reaction is closer to how a mortal reacts to weather.'
    },
    {
