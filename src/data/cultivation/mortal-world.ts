...
const OCCUPATION_DATA: readonly Occupation[] = [
    ...
    { id: 'job-quay-watch', name: 'Quay watch', kind: 'cultivator', minOrdinal: 3, cashPerMonth: 1_300, settlements: ['market_town', 'city'], risk: 'moderate', note: 'The Thousand Sail Harbour Rail\'s funded order, and the only paid watch in the world that is honest about where its writ stops. It handles theft, brawls and short weight, and is told at hiring that it does not go above Foundation Establishment.' },
...
export const PRICES: readonly Price[] = [
    ...
    { id: 'price-water-jar', name: 'Fresh water, sealed stone jar', category: 'food', cash: 30, unit: 'jar', note: 'Six days for one person at the standing ration, and the actual binding constraint on every passage in the province. Thousand Sail Harbour sells it at a margin nobody argues about, because a shipmaster haggling over water in front of a crew has already lost the crew.' },
    { id: 'price-hull-repair', name: 'Hull repair at a quay', category: 'service', cash: 2_200, unit: 'per call', note: 'Caulking, cordage and canvas. The Thousand Sail Harbour Rail keeps eleven caulkers and does not price them to profit, on the reasoning that a hull that cannot be repaired there is a hull that stops coming.' },
