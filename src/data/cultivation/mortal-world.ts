...
const OCCUPATION_DATA: readonly Occupation[] = [
    ...
    { id: 'job-escort', name: 'Caravan escort (cultivator)', kind: 'cultivator', minOrdinal: 5, cashPerMonth: 2_000, settlements: ['market_town', 'sect_town', 'city'], risk: 'high', note: 'Underwritten by the Stone Marrow Hall, which prices the contract off its own rank table - the table that reads Silent Cliffs carvers a rank low.' },
