...
export const CONTRACTS: readonly Contract[] = [
    ...
    { id: 'contract-cave-sitter', name: 'Grotto vigil', minOrdinal: 2, cashPerMonth: 800, days: 90, settlements: ['sect_town', 'village'], risk: 'low', note: 'Sitting in somebody else\'s rented cave so the claim does not lapse while they are away. Dull, safe, and the sitter cultivates on their employer\'s ground, which is the actual pay.' },
    ...
    { id: 'contract-beast-culler', name: 'Spirit-beast culling', minOrdinal: 3, cashPerMonth: 1_200, days: 30, settlements: ['village', 'market_town', 'sect_town'], risk: 'high', note: 'Paid per head on a village contract. The standard living for an unaffiliated Qi Condensation cultivator, and the standard way one dies at twenty-six.' },
    ...
    { id: 'contract-gleaner', name: 'Scorched-zone gleaning', minOrdinal: 4, cashPerMonth: 3_000, days: 90, settlements: ['village', 'market_town'], risk: 'lethal', note: 'Buddha Precipice only. The best-paid paper open to a Qi Condensation cultivator anywhere, and it kills about one in nine a season.' },
    { id: 'contract-escort', name: 'Caravan escort', minOrdinal: 5, cashPerMonth: 2_000, days: 30, settlements: ['market_town', 'sect_town', 'city'], risk: 'high', note: 'Underwritten by the Stone Marrow Hall, which prices the contract off its own rank table - the table that reads Buddha Precipice carvers a rank low.' },
    { id: 'contract-tutor', name: 'Tutoring a merchant family', minOrdinal: 5, cashPerMonth: 900, days: 90, settlements: ['market_town', 'city'], risk: 'none', note: 'Teaching a merchant\'s child the Lesser Qi-Gathering Manual. Humiliating, safe, and the fastest way for a low-realm cultivator to meet people with money.' },
    ...
    { id: 'contract-formation-hand', name: 'Formation node tending', minOrdinal: 8, cashPerMonth: 1_500, days: 30, settlements: ['sect_town', 'city'], risk: 'moderate', note: 'Holding nodes steady while somebody who understands them works. Impossible in the Buddha Precipice, where formations do not run at all.' },
    { id: 'contract-boundary-arbiter', name: 'Boundary arbitration', minOrdinal: 29, cashPerMonth: 120_000, days: 30, settlements: ['sect_town', 'city'], risk: 'none', note: 'Two houses disagree about a vein and neither will accept the other\'s survey. What is being bought is somebody both sides would rather not argue with.' },
    { id: 'contract-retained-deterrent', name: 'Standing deterrence', minOrdinal: 31, cashPerMonth: 250_000, days: 90, settlements: ['sect_town', 'city'], risk: 'none', note: 'Paid to be resident and visible and to do nothing at all. The contract specifies attendance and says nothing about work, because the work is the attendance.' },
