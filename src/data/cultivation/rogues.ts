...
export const ContractSchema = z.object({
    ...
    said: z.string().min(4),
    /**
     * The paper as it reads on the wall. Slots: `{place}`, the town the wall is
     * in, and `{term}`, which is always `days`. See `aTaskAsPosted`.
     */
    task: z.string().min(1),
...
export const CONTRACTS: readonly Contract[] = [
    { id: 'contract-face-labour', said: 'face carving', task: 'Do face carving on somebody\'s grant at {place} for the next {term}', minOrdinal: 0, cashPerMonth: 700, days: 30, settlements: ['market_town'], risk: 'high', note: 'Buddha Precipice only. Cutting a face on somebody else\'s grant for a share of what comes out, and inhaling the reason carvers die at forty.' },
    { id: 'contract-cave-sitter', said: 'grotto vigil', task: 'Sit a grotto vigil in a rented cave at {place} for the next {term}', minOrdinal: 2, cashPerMonth: 800, days: 90, settlements: ['sect_town', 'village'], risk: 'low', note: 'Sitting in somebody else\'s rented cave so the claim does not lapse while they are away. Dull, safe, and the sitter cultivates on their employer\'s ground, which is the actual pay.' },
    { id: 'contract-quay-watch', said: 'quay watch', task: 'Keep the quay watch at {place} for the next {term}', minOrdinal: 3, cashPerMonth: 1_300, days: 30, settlements: ['market_town', 'city'], risk: 'moderate', note: 'Silver Island Hall\'s funded order, and the only paid watch in the world that is honest about where its writ stops. It handles theft, brawls and short weight, and is told when it signs on that it does not go above Foundation Establishment.' },
    { id: 'contract-beast-culler', said: 'beast culling', task: 'Do the spirit beast culling for the villages around {place} for the next {term}', minOrdinal: 3, cashPerMonth: 1_200, days: 30, settlements: ['village', 'market_town', 'sect_town'], risk: 'high', note: 'Paid per head on a village contract. The standard living for an unaffiliated Qi Condensation cultivator, and the standard way one dies at twenty-six.' },
    { id: 'contract-courier', said: 'courier', task: 'Carry courier paper out of {place} for the next {term}', minOrdinal: 4, cashPerMonth: 1_100, days: 20, settlements: ['market_town', 'sect_town', 'city'], risk: 'moderate', note: 'Shrinking Earth Pavilion paper, paid per true li rather than walked. The Span will not sign anyone who cannot read its two-number directions.' },
    { id: 'contract-gleaner', said: 'gleaning', task: 'Do scorched-zone gleaning out of {place} for the next {term}', minOrdinal: 4, cashPerMonth: 3_000, days: 90, settlements: ['village', 'market_town'], risk: 'lethal', note: 'Buddha Precipice only. The best-paid paper open to a Qi Condensation cultivator anywhere, and it kills about one in nine a season.' },
    { id: 'contract-escort', said: 'caravan escort', task: 'Ride caravan escort out of {place} for the next {term}', minOrdinal: 5, cashPerMonth: 2_000, days: 30, settlements: ['market_town', 'sect_town', 'city'], risk: 'high', note: 'Underwritten by the Stone Marrow Hall, which prices the contract off its own rank table - the table that reads Buddha Precipice carvers a rank low.' },
    { id: 'contract-tutor', said: 'tutoring', task: 'Take up tutoring for a merchant family at {place} for the next {term}', minOrdinal: 5, cashPerMonth: 900, days: 90, settlements: ['market_town', 'city'], risk: 'none', note: 'Teaching a merchant\'s child the Lesser Qi-Gathering Manual. Humiliating, safe, and the fastest way for a low-realm cultivator to meet people with money.' },
    { id: 'contract-dangerous-herb-gathering', said: 'guarded ground', task: 'Gather herbs on guarded ground around {place} for the next {term}', minOrdinal: 6, cashPerMonth: 1_800, days: 30, settlements: ['village', 'market_town'], risk: 'high', note: 'Earth-grade herbs grow where something is living. Pays four times a picker and kills about one gatherer in twenty a year.' },
    { id: 'contract-formation-hand', said: 'node tending', task: 'Do formation node tending at {place} for the next {term}', minOrdinal: 8, cashPerMonth: 1_500, days: 30, settlements: ['sect_town', 'city'], risk: 'moderate', note: 'Holding nodes steady while somebody who understands them works. Impossible in the Buddha Precipice, where formations do not run at all.' },
    { id: 'contract-boundary-arbiter', said: 'boundary arbitration', task: 'Sit a boundary arbitration between two houses at {place} for the next {term}', minOrdinal: 29, cashPerMonth: 120_000, days: 30, settlements: ['sect_town', 'city'], risk: 'none', note: 'Two houses disagree about a vein and neither will accept the other\'s survey. What is being bought is somebody both sides would rather not argue with.' },
    { id: 'contract-retained-deterrent', said: 'standing deterrence', task: 'Stay in residence at {place} as standing deterrence for the next {term}', minOrdinal: 31, cashPerMonth: 250_000, days: 90, settlements: ['sect_town', 'city'], risk: 'none', note: 'Paid to be resident and visible and to do nothing at all. The contract specifies attendance and says nothing about work, because the work is the attendance.' },
    { id: 'contract-lid-assay', said: 'lid assay', task: 'Make a Lid assay over {place} for the next {term}', minOrdinal: 42, cashPerMonth: 5_000_000, days: 20, settlements: ['city'], risk: 'high', note: 'Reading how much of the ceiling is left over a place, for people who have a reason to want the number and no way at all to take it themselves.' }
];
