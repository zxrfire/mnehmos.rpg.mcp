...
const ABOUT_PLACES: readonly Rumour[] = [
    ...
    },
    {
        ...
        saying: 'Clear River Ford. Named for the water, obviously. There is water and it comes off the bad ground and you do not drink it.',
        saidBy: 'a Clear River Ford market trader, patiently',
        aboutId: 'region-low-fall',
        aboutName: 'Clear River Ford',
        accuracy: 'true',
