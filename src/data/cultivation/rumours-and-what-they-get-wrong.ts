...
const ABOUT_CULTIVATORS: readonly Rumour[] = [
    ...
    },
    {
        ...
        saying: 'If the boy is quick they will take him. They came through the year of the flood and took two from Old River Village, and their people eat every day.',
    ...
    },
    {
        ...
        saying: 'A cup of it and a broken leg knits in a night. There is a man in Sweet Spring Island who sells it and it is not his.',
...
const ABOUT_INSTITUTIONS: readonly Rumour[] = [
    ...
    },
    {
        ...
        saidBy: 'a Jade Gorge grant clerk, explaining to a junior why a probationary court is renewed anyway',
        aboutId: 'sect-storm-tyrant-court',
    ...
    },
    {
        ...
        consequence: 'The site stays sealed because the story does the work a perimeter would cost money to do, and the Caravan is aware of this and has never said so.',
        floorOrdinal: 6,
        regionId: 'region-quiet-marches',
    ...
    },
    {
        ...
        saidBy: 'a Jade Gorge elder, closing the subject',
    ...
    },
    {
        ...
        consequence: 'Every unexplained closure in the Jade Gorge is attributed upward, so the actual pattern of who closes roads is invisible to everybody who is not counting.',
        floorOrdinal: 0,
        regionId: 'region-low-fall',
        insiderFactionId: null
    },
    ...
    },
    {
        ...
        saidBy: 'a Jade Gorge trader warning a newcomer',
    ...
    },
    {
        ...
        saying: 'Nothing under the Jade Gorge is anybody\'s until it has been signed for, and there is one signature, and you will never see the hand.',
        saidBy: 'a vein steward explaining a delay',
        aboutId: 'apex-earth-vein-tower',
...
const ABOUT_PLACES: readonly Rumour[] = [
    ...
    },
    {
        ...
        saidBy: 'a Jade Face carver at the end of a season',
        aboutId: 'region-quiet-marches',
    ...
    },
    {
        ...
        saidBy: 'boys from Sweet Spring Island, who go there on a dare',
        aboutId: 'region-drowned-reach',
    ...
    },
    {
        ...
        saying: 'Clear River Ferry. Named for the water, obviously. There is water and it comes off the bad ground and you do not drink it.',
        saidBy: 'a Clear River Ferry market trader, patiently',
        aboutId: 'region-low-fall',
        aboutName: 'Clear River Ferry',
        accuracy: 'true',
    ...
    },
    {
        ...
        saying: 'They count you out at Fourfold Stele and they count you back. If the numbers do not match they do not send anybody after you. They write it down.',
        saidBy: 'a waystation keeper, stating the policy',
        aboutId: 'region-white-stair',
        aboutName: 'Fourfold Stele',
        accuracy: 'true',
    ...
    },
    {
        ...
        saidBy: 'a Yellow Plain carter, who lost one',
        aboutId: 'region-wide-field',
        aboutName: 'Insects Awaken',
        accuracy: 'true',
        ...
        consequence: 'Yellow Plain carters route around a site in the wet season, which adds a day and is the reason the road bends where it does.',
        floorOrdinal: 0,
    ...
    },
    {
        ...
        saying: 'Three Walls, because there were two before it. Both came down. This one has not, yet, and people say yet.',
        saidBy: 'a Yellow Plain city gate guard',
        aboutId: 'region-wide-field',
        aboutName: 'Three Walls',
        accuracy: 'unresolved',
