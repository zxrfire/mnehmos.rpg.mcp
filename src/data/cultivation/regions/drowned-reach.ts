/**
 * The Drowned Reach: open water, no ground under it, so no vein under it, so
...
export const THE_DROWNED_REACH: Region = {
    ...
    customs: {
        ...
        naming: 'Hulls and landfalls instead of clans: Bell of the Third Landfall, Ma out of Kettle, Sweetspring Isle Xu. A person at sea is named for where they came aboard, and nobody asks past that.',
    ...
    branches: [
        {
            ...
            doesHere:
                'Takes a hull from the river mouth as far as Sweetspring Isle and refuses to go one landfall further, on the stated principle that a ferryman who cannot see both banks is a passenger. It is the only regular service between the land and the water and it has never lost a hull, which is the same fact twice.'
        },
        {
            parentSectId: 'sect-thousand-treasure-pavilion',
            localName: 'The Sweetspring Isle Floor',
            doesHere:
    ...
    places: [
        ...
        { name: PLACE.THE_FAR_SHORE, kind: 'waystation', ambient: 'thin', note: 'A gate station on a shore three weeks\' sail out and one hour from the Low Fall, when it opens, which is four days in nine and never in a storm.' },
        // ── the middle of the water, which was a gap in the map ────────
        //
        // The province was written as coasts and the water between them
        // was nothing: Sweetspring Isle and Bronze Bell Cape and The Far Shore are all edges,
        ...
        { name: PLACE.THOUSAND_SAIL_HARBOUR, kind: 'city', ambient: 'thin', note: 'An island at the middle of the eastern passage with a deep anchorage, no vein and no patron, where every party in the world buys and sells because none of them owns it. The largest market outside the nine cities and the only one an apex has never had a seat at.' },
        { name: PLACE.THE_WAITING_SAILS, kind: 'site', ambient: 'thin', note: 'The anchorage off Thousand Sail Harbour, where forty hulls lie waiting on wind, water or a price, close enough to hear each other\'s bells. A quarter of the port\'s business is done between hulls without anybody going ashore.' },
    ...
    connections: [
        {
            ...
            description:
                'Nine days down the river and out to Sweetspring Isle, which is where the Low Fall\'s river stops being a river. Salt and drowned goods up, pills and grain down, and the Alliance turns round at the first landfall every time.',
            travelDays: 9
        },
        {
            kind: 'sea_crossing',
            ...
            description:
                'Twenty-one days from Sweetspring Isle to the eastern shore, three seasons in four, across a stretch with no landfall in the middle of it. It is the busiest water in the province and every hull on it is a sum that has to come out right.',
            travelDays: 21
        },
        {
            kind: 'sea_crossing',
