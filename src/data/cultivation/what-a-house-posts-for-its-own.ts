...
export const HOUSE_MISSIONS: readonly HouseMission[] = [
    ...
    { id: 'mission-tide-breaker', name: 'Surge breaker', minOrdinal: 25, cashPerMonth: 45_000, days: 25, settlements: ['village', 'market_town', 'sect_town'], risk: 'lethal', needs: 'ground', note: 'A beast tide is coming at the settlements under the house\'s ground, and the house sends what it has. Paid on the count of what is standing afterwards, which is a payment structure with an obvious defect.' },
