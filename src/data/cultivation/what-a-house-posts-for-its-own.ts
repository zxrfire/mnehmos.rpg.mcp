 ...
 * seal inspection. And a house only posts what somebody on its roll could do:
...
export const HOUSE_MISSIONS: readonly HouseMission[] = [
    ...
    { id: 'mission-vein-warden', name: 'Vein warden', minOrdinal: 21, cashPerMonth: 12_000, days: 90, settlements: ['sect_town', 'city'], risk: 'moderate', needs: 'ground', note: 'Sitting on the house\'s vein so that nothing else draws on it. The pay is nominal; what the house is actually giving is the right to cultivate on the ground being guarded.' },
    ...
    { id: 'mission-tide-breaker', name: 'Tide breaker', minOrdinal: 25, cashPerMonth: 45_000, days: 25, settlements: ['village', 'market_town', 'sect_town'], risk: 'lethal', needs: 'ground', note: 'A beast tide is coming at the settlements under the house\'s ground, and the house sends what it has. Paid on the count of what is standing afterwards, which is a payment structure with an obvious defect.' },
    { id: 'mission-formation-keeper', name: 'Formation keeper', minOrdinal: 27, cashPerMonth: 60_000, days: 90, settlements: ['sect_town', 'city'], risk: 'low', needs: 'nothing', note: 'Holding a great formation steady across a season. Dull, safe, extremely well paid, and the standard way a house finds out what one of its own actually knows.' },
    ...
    { id: 'mission-seal-inspection', name: 'Seal inspection', minOrdinal: 35, cashPerMonth: 700_000, days: 20, settlements: ['sect_town', 'city'], risk: 'lethal', needs: 'a_containment', note: 'Going down to a seal that has held for two ages and reporting whether it still does. The pay is large because the reporting half is not reliably included.' },
