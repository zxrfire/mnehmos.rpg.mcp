...
const AUTHORED_MEMBERS: readonly Member[] = [
    ...
    },
    {
        ...
        teaching: {
            ...
            mayNotSay: 'Next quarter\'s rate, which is a Rate Elder\'s and is a hanging matter, and she will name the punishment rather than pretend not to know the number.',
    ...
    // --- Cold Sword Sect ---------------------------------------------------
    {
        ...
        realmOrdinal: 2,
        role: 'peer',
        wants: 'to be told he is standing wrong, by anybody, once',
        fears: 'that nobody here is watching closely enough to correct him',
        detail: 'Turns up an hour before the draw to sweep a yard nobody asked him to sweep, and has done for two years.',
        outlier: false,
        outlierReason: null,
        goodCompany: true,
        rivalry: null,
    ...
    },
    {
        ...
        realmOrdinal: 4,
        role: 'peer',
        wants: 'the terraces to have given a reason',
        fears: 'being asked what the reason was, because she does not know and has to say so',
        detail: 'Carries the probation chit the Azure Cloud Pavilion issued her, unfolded so often the fold has gone through the paper.',
        outlier: false,
        outlierReason: null,
        goodCompany: false,
        rivalry: null,
    ...
    },
    {
        ...
        realmOrdinal: 8,
        role: 'peer',
        wants: 'to reach the flight and then be difficult about it',
        fears: 'the year the yard runs out of book, which he can date',
        detail: 'Keeps a count of how many mornings each person in the yard has attended, on a board nobody asked him to keep, and is scrupulous about it.',
        outlier: false,
        outlierReason: null,
        goodCompany: true,
        rivalry: null,
    ...
    },
    {
        ...
        realmOrdinal: 16,
        role: 'master',
        wants: 'one page of the road above the tempering scripture, from anybody, on any terms',
        fears: 'that the terms would be accepted by somebody else in the yard while she was away',
        detail: 'Has taught the blade flight to nineteen people and has written none of it down, because writing it down is the thing the terraces would object to.',
        outlier: false,
        outlierReason: null,
        goodCompany: true,
        rivalry: null,
        teaching: {
            knows: 'The metal road to the end of the tempering scripture, the flying blade, and standing on a blade in weather, which is the part no book covers.',
            mayNotSay: 'Where she learned the flight, because she was taught it on the terraces before she was sent down and the person who taught her is still there.',
            costsThem: 'Every hour in the yard is an hour not spent on a ceiling she reached eleven years ago and has no book to pass.'
        }
    },
    {
        id: 'member-wei-shenchuan',
        name: 'Wei Shenchuan',
        factionId: 'sect-cold-sword-sect',
        rankIndex: 5,
        rank: 'Sect Master',
        realmOrdinal: 22,
        role: 'senior',
        wants: 'nothing that anybody in the Jade Gorge is in a position to give him',
        fears: 'that somebody he taught is used for something the province cannot overlook',
        detail: 'Arrived at the yard already standing where he stands, will not say from where, and has never been asked twice.',
        outlier: true,
        outlierReason: 'arrived',
        goodCompany: false,
        rivalry: null,
    ...
    },
    {
        ...
        realmOrdinal: 27,
        role: 'senior',
        wants: 'a season without a Karma Palace reckoner in the building',
