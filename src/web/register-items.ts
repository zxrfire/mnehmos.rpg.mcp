...
<section>
  ...
  <p class="note"><strong>Two rungs decide what a species is to whoever goes after it, and they are twelve apart.</strong> At ordinal ${BEAST_CORE_ORDINAL} a beast condenses a core and can say nothing about it. At ordinal ${BEAST_CHANGE_ORDINAL} it takes a shape and a voice and is thereafter a party who can decline. The <em>held as</em> column is that boundary: counted below the core, tracked between, and somebody above.</p>
