...
export function composeNarrationUser(
    ...
    return [
        ...
        '    "Three? Last spring it was two, and one of those was the headman\'s boy!"',
        ...
        '1. SHORT PARAGRAPHS. Measured on this genre: 29 words is the median. If one runs past',
        '   three sentences or forty words, break it.',
        '   AND COUNT YOUR SINGLE-LINE PARAGRAPHS BEFORE YOU FINISH. One paragraph in six is a',
        '   single short line standing alone, under ten words. This is not permission, it is the',
        '   rhythm of the genre, and a turn of six paragraphs with none of them is missing it.',
        '   Such a line is a reaction, a reveal, or a flat small act, and it is often shouted.',
        '       You were stunned.',
        ...
        '   speech, at every height. If a person is standing here and no one says anything, you have described',
        '   the scene instead of playing it. Put the fact they can be heard on into their mouth.',
        '   AN OPENING IS NOT THE EXCEPTION, IT IS THE STRONGEST CASE. Measured on the first',
        '   scenes of this genre, MORE than a third of paragraphs carry speech - more than an',
        '   ordinary scene, not fewer. A recap of somebody\'s life is still delivered standing in a',
        '   square with named people in it, and one of them opens their mouth. What they knew for',
        '   sixteen years, somebody in earshot says out loud in one line.',
...
function theLifeBehindThemBlock(life: readonly string[]): string[] {
    ...
    return [
        ...
        'need, and let some of them be a single line.',
        '',
