...
export function describeTheRoom(company: Company | null | undefined): string[] {
    ...
    return [
        ...
        'of a square. LIKE THIS, AND NOTE THAT NOT ONE OF THEM SAYS WHO SPOKE:',
        '',
        '    "Fifteen stones for a block-print."',
        '',
        '    "Fifteen because it is the only one on the shelf."',
        '',
        '    "And the boy has no house to pay for it."',
        '',
        'MEASURED, THIS IS THE RULE THE NARRATION BREAKS MOST. Pooled over played turns, three',
        'quarters of spoken paragraphs carried a speech verb where this genre carries one in',
        'four, and almost all of the excess was the crowd: "a voice calls out from the crowd",',
        '"another voice adds", "someone shouts". Every one of those is a speaker identified and',
        'a verb spent to identify them. THE QUOTATION MARKS ALREADY SAY SOMEBODY SPOKE. Where',
        'the line came out of a crowd, that it came out of a crowd is the one thing the reader',
        'does not need told - there is nobody else it could have come from.',
        '',
...
export function composeNarrationUser(
    ...
    return [
        ...
        '    "Three hundred." The stallholder does not raise his head. "Fellow Daoist, at four',
        ...
        '    stallholder taps the slips instead. "Fifteen for the one. Twenty-five for the',
        '    other, and you have not got the breath for it."',
        '    The board has the usual on it, down to the price of ground for a grave. Only one',
        ...
        'genre.',
        '    Two elders of the same house have been feuding ninety years over the use of a',
        '    single well, and three disciples are dead of it. Nobody in the valley finds this',
        '    worth remarking on.',
        '',
        ...
        '    "Senior, this junior meant no offense!" you say at once, bowing until your',
        ...
        '',
        '    The stall is a board on two trestles, and the man behind it does not look up when your',
        '    shadow falls across the slips he has laid out.',
        '',
        '    "Fifteen," he says, before you have asked.',
        '',
        '    You heard twelve in the spring. You say so, and he turns the slip over without any',
        '    particular hurry, so that the damp along the spine shows, and says fifteen again.',
        '',
        '    Behind you two men are going at the caravan intake, which opens in twenty-four days and',
        ...
        'hits them.',
        '',
        'THE CULTIVATOR IS YOU. Second person for the person whose turn this is - you look, you',
        'pay, your purse holds thirty stones - and third for everybody else. This was never',
        'written down and was being learned from the examples alone, which is exactly how the',
        'tense below went wrong.',
        '',
        'AND IT IS IN THE PRESENT. The scene happens as it is read: the stall IS a board on two',
        'trestles, he SAYS fifteen, you PAY it. Past tense is for what is already over - what',
        'somebody heard in the spring, what a house did four hundred years ago, what a speaker',
        'is recalling inside their own quotation marks. Measured in play, one turn of a run slid',
        'into the past for its whole length while the turns either side stayed in the present,',
        'and inside one session that reads as two different narrators.',
        '',
        ...
        '       She does not move.',
        '       Thirty stones, and the book is fifteen.',
        '       "There is no chance!"',
        '       "It was seven."',
        '       His scalp prickles.',
        '       He does not look up.',
        '       It is that house\'s own mark!',
        '       Thirty stones, and the book is fifteen.',
        '       "It was seven."',
        '       Your scalp goes numb.',
        ...
        '   worth a clause - he does not look up, she puts the slip down. Not otherwise.',
        '   SO COUNT THE ATTRIBUTIONS BEFORE YOU FINISH, the way you count the short lines.',
        '   Take the paragraphs that carry a quotation. AT MOST ONE IN FOUR OF THEM may also',
        '   carry says, asks, answers, calls, adds, murmurs or replies. If you have three',
        '   quoted paragraphs and three speech verbs, strike two of them out - the line does',
        '   not need a hand pointing at whoever said it. This is the rule you break most',
        '   often and the one that separates this register from ordinary fiction: measured',
        '   across this genre, three quarters of spoken paragraphs name no speaker at all.',
