...
export function composeNarrationUser(
    ...
    return [
        ...
        '   any height.',
        '   So count them before you finish. If nothing you have written is a single line under',
        '   fifteen words, you have not written the rhythm. That line is a reaction, a reveal or',
        '   a flat small act, and it is often shouted.',
        '       You were stunned.',
