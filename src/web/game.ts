...
import { stagnationRemaining, turnsUntilStarvation } from '../engine/cultivation/survival.js';
...
import { couldFoldThere } from '../engine/world/how-far-somebody-can-fold-space-and-what-it-costs.js';
...
import { carriedAcross, type RosterEntry } from '../storage/repos/cultivator.repo.js';
import {
...
export interface GameService extends TravelVerbs, CombatVerbs, InvestigateVerb, AskingVerbs {}
...
Object.assign(GameService.prototype, travelVerbs, combatVerbs, investigateVerb, askingVerbs);
