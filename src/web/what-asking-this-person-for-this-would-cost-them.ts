 ...
 *
 * The read is symmetric, so `whatTheyWouldTeachYou(player, them)` answers which
 * of the player's arts are theirs to hand on. The act is
 * `teaching-somebody-what-you-hold.ts`.
 *
