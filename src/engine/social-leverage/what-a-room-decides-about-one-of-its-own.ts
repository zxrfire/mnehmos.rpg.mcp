 ...
 *
 * ═════════════════════════════════════════════════════════════════════════
 * AND SOMEBODY WHO IS NOT ONE OF ITS OWN
 * ═════════════════════════════════════════════════════════════════════════
 *
...
export interface WhatWasBrought {
    ...
    /**
     * Whether they are one of the house's own. Absent reads as yes, which is
     * every caller this file was written for. See {@link WHAT_A_SENTENCE_NEEDS}
...
/**
 * What each sentence needs before a house can hand it down, and nothing else.
 *
 ...
 *                     is the rule this file already had for members.
