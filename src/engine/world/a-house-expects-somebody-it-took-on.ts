...
export function questionedByTheInternalAffairsElder(
    ...
    if (there === null) {
        ...
        //
        // Played: a Cistern Servant taken on at the Wind Turn intake was turned away from
        // the gate the next day on this line, while every look in the same run
        // said the house had them down as Cistern Servant. Two records of one membership,
