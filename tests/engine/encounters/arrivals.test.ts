...
const facts: Fact[] = [
    ...
    { id: 'f4', day: 700, magnitude: 0.65, kind: 'collapse', summary: 'Ninefold Buddha Precipice folded its outer gate.', consequence: 'A village that used to pay a tithe has stopped, and the tithe collector has not come back.' }
];
