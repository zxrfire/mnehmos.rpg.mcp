 ...
 *      type's own docstring names as the defect. Clear River Ferry is not eleven days
...
function noAuthority() {
    return reading(
        [
            ...
            makeLocation({ id: 'g', name: 'Bronze Gong Cliff', kind: 'settlement', parentId: 'r' })
        ],
        'g'
    );
}

/** Clear River Ferry: on the register with nobody's name against it, inside a province. */
...
describe('the ground under two people', () => {
    ...
    /**
     * Clear River Ferry is inside a province with a survey, a bench and a register, and
 ...
 *      about deception; and Clear River Ferry is worth less to a threatener than it
 *      costs a stranger.
...
describe('the ground under a threat', () => {
    ...
    it('is not the trust reading with a minus sign in front of it', () => {
        ...
        // Clear River Ferry: the un-appointed keepers of an unheld ford have more
