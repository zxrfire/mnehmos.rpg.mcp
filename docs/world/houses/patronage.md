<!-- tier: 2 trigger="how houses stand relative to one another, and who holds a vein from whom" -->

# Patronage

The pyramid and the vein network, the feeder relationship, guest elders, the
unbacked, and the houses that rule directly instead.
