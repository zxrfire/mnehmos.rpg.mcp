<!-- tier: 2 trigger="a house's ancestors, its prestige, or an offering to one is in play" -->

# Ancestors

Ancestral records, the millennial offering, the two kinds of ancestor, and how a
house's prestige decays as its crossing recedes.
