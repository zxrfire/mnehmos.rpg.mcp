...
| the player asks what lies beyond what they have already met | [`discovery.md`](discovery.md#three-ways-in-and-they-are-different-questions) | Three ways in, and they are different questions (tier 2) |
...
| the player is above Foundation and asks what is around them | [`discovery.md`](discovery.md#what-you-can-see-which-is-not-what-you-have-been-told) | What you can see, which is not what you have been told (tier 2) |
...
| the player puts weight behind a question | [`discovery.md`](discovery.md#making-somebody-tell-you) | Making somebody tell you (tier 2) |
...
**49 catalog files, 16 of which name a doc.**
...
| [`places-that-teach-a-dao.ts`](../../src/data/cultivation/places-that-teach-a-dao.ts) | Places that teach a dao: named ground where a road besides your own can be walked, and who is standing on the door. | 629 | [`immortals.md`](immortals.md) |
...
| [`regions.ts`](../../src/data/cultivation/regions.ts) | Regions - five of them, and the contrast between them is the content. | 3205 | [`making-places-different.md`](making-places-different.md) [`qi.md`](qi.md) |
...
| [`sects.ts`](../../src/data/cultivation/sects.ts) | Sects - the social layer, and the only reliable source of manuals, stipends, pills and enemies. | 3602 | [`past-the-ceiling.md`](past-the-ceiling.md) |
