...
| [`beasts.ts`](../../src/data/cultivation/beasts.ts) | Spirit beasts - the part of the world that is dangerous and is not a person. | 3296 | [`trust.md`](houses/trust.md) |
...
| `BEASTS` | [`beasts.ts`](../../src/data/cultivation/beasts.ts) | 15 | 99 |
