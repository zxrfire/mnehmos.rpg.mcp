<!-- tier: 2 trigger="the player asks anyone about anything they do not already know" -->
...
Someone who has reason to talk to you - a master, a debtor, someone who wants something -
gives a real answer, bounded by what they know, what they are allowed to say, and what it
costs them to say it. Those are three different limits and all three apply.

**Ignorance and evasion should be hard to tell apart at first and easy later.** That is the
whole texture of it.
...
rather than curiosity. Mentioning an obligation. Knowing enough to ask the narrower
question.

The person reassesses what they are talking to, and *then* answers.

Getting it wrong cuts the other way. Using a term you do not understand, to someone who
...
Every run starts in the same ignorance. But the person playing has learned who is worth
asking, what makes someone talk, and what a deflection looks like. Nothing carries on the
character. Everything carries in the player.

Two things follow, and they are the only rules here:

- **Do not randomise across runs.** The world's habits should be stable enough to learn.
- **Do not gate it behind progress.** If a first-hour player asks well, it works.
