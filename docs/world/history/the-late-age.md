<!-- tier: 2 trigger="exploration, ruins, inheritances, or any question about why the world is the way it is" -->

# The Late Age

Why the world is poorer than it was, what a sealed ruin actually is, and the texture to
...
<!-- tier: 2 trigger="the player is exploring, entering a sealed site, or considering grave-reading" -->
...
<!-- tier: 2 trigger="describing anything old, ruined, inherited, or built by someone else" -->
