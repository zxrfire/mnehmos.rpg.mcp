...
| [`look`](#look) | `intent` `target` | nothing | yes | yes | [14](#look) |
...
Intents: `history`, `ground_time`, `crowding`, `bills`, `company`, `holder`, `warmth`, `what_they_hold`, `what_they_teach`, `who_is_above_them`, `what_is_made_here`, `would_they_take_me`, `the_gate`, `their_people_here`.
