...
| [`src/web/README.md`](src/web/README.md) | The narrator's three-phase split, the closed action enum, why `intent` is open but never branched on, target resolution, the deterministic fallback, and where the authority boundary lives in code |
